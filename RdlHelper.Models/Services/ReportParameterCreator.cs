...
//        internal ReportParameter Create(string name, RdlParameterDataType dataType, string prompt, RdlParameterOption options)
//        {
...
//            var rdlParameter = new ReportParameter(this, rpEl);
...
//            var dataTypeValue = _xmlDocument.CreateTextNode(Report.RdlDataTypeToString[dataType]);
